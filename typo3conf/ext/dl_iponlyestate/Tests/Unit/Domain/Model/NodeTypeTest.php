...
/**
 * Test case for class \DanLundgren\DlIponlyestate\Domain\Model\NodeType.
 *
 ...
 */
class NodeTypeTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	...
	{
		$this->subject = new \DanLundgren\DlIponlyestate\Domain\Model\NodeType();
	}

...
/**
 * Test case for class DanLundgren\DlIponlyestate\Controller\ReportController.
 *
...
class ReportControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \DanLundgren\DlIponlyestate\Controller\ReportController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('DanLundgren\\DlIponlyestate\\Controller\\ReportController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllReportsFromRepositoryAndAssignsThemToView()
	{
		...
		$reportRepository = $this->getMock('DanLundgren\\DlIponlyestate\\Domain\\Repository\\ReportRepository', array('findAll'), array(), '', FALSE);
